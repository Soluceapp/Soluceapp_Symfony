function sub_menu1() {window.location.assign("../html/accueil.html"); }
function sub_menu2() {window.location.assign("../html/petitchevaux.html"); }
function sub_menu3() {window.location.assign("../html/motcroises.html"); }
function sub_menu4() {window.location.assign("../html/memory.html");}
...
function sub_menu8() {window.location.assign("../html/motsmeles.html");}
function sub_menu10() {window.location.assign("../html/musique.html");}
function sub_menu11() {window.location.assign("../html/courtmetrage.html");}
function sub_menu12() {window.location.assign("../html/escapem.html");}
function sub_menu13() {window.location.assign("../html/entreprise_virtuelle.html");}
function sub_menu14() {window.location.assign("../html/vervischapp.html");}
function sub_menu15() {window.location.assign("../html/musee3D.html");}
