...
class ChangeevalsFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        'choice_label'=>function(Dutil $dutil){  return $dutil->getPrenom() . '  ' . $dutil->getNom() . ', Eco : ' . $dutil->getNoteEvalEco() . ' /20, Gestion : ' . $dutil->getNoteEvalGestion() . ' /20' . ', Outils : ' . $dutil->getNoteEvalOutilGestion() . ' /20' ; },
        ...
        ->add('points', ChoiceType::class,['attr'=> ['class' =>'style26'],'label' =>'Variation de notes ','choices'  => ['+1' => 1, '+2' => 2, '-1' => -1 ]])
